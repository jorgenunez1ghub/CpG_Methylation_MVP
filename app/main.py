...
def _streamlit_cached_functions():
    ...
    return (
        st.cache_data(show_spinner=False)(load_methylation_file_cached),
...
def main() -> None:
    ...
    cached_load_methylation_file, cached_analyze_methylation = _streamlit_cached_functions()
    ...
    if uploaded_file is not None:
        try:
            ...
            normalized_df = cached_load_methylation_file(raw_bytes=raw_bytes, filename=uploaded_file.name)
